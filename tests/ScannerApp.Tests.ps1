...
Assert-AppTest ($moduleSource -match 'Test-CompuTekTrustedMicrosoftApplication' -and $postScamSource -match 'Test-CompuTekPostScamUserWritableRisk' -and $postScamSource -match '\$isTrustedMicrosoftApp') 'Teams and OneDrive require expected Microsoft paths and valid signatures before user-profile heuristics suppress them'
